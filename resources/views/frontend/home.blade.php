...
@section('content')
    ...
    <section class="w-full h-[782px]">
        <div class="relative">
            ...
            <div class="flex justify-around items-center absolute left-[100px] w-[400px] h-[80px] rounded-2xl bg-white shadow-2xl hover:shadow-yellow-700 font-bold text-[27px] text-[#A95634] px-5">
                <a href="#" class=" ">
