                ...
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-3">
                        <div class="text-base/7 font-semibold text-gray-900">
                            {{ trans('global.edit') }} {{ __('labels.role.title_singular') }}
                        </div>
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="name" id="name" value="{{ old('name', $role->name) }}" autocomplete="given-name" required
                                ...
                                <fieldset>
                                    <div class="sm:flex sm:items-center">
                                        <div class="sm:flex-auto">
                                            ...
                                            <div class="">
                                                <label for=""
                                                    class="text-base font-semibold text-gray-900 pr-4">{{ __('labels.permission.title') }}
                                                ...
                                                <div class="w-full md:w-1/4 px-2 my-1">
                                                    <div class="my-2">
                                                        <input type="checkbox" id="permission{{ $row->id }}"
                                                            ...
                                                            value="{{ $row->name }}"
                                                            @if (in_array($row->id, $role->permissions->pluck('id')->toArray())) checked @endif
                                                            @if ($errors->has('permissions')) aria-invalid="true" @endif>
                                                        <label class="ml-2"
