                ...
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <div class="text-base font-semibold text-gray-900">
                            {{ __('labels.section.title') }}
                        </div>
                        <p class="mt-2 text-sm text-gray-700">{{ __('labels.section.description') }}</p>
                    </div>
                </div>
...
@section('scripts')
    @parent
    <script>
        if (document.getElementById("section-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            const dataTable = new simpleDatatables.DataTable("#section-table", {
                searchable: true,
                sortable: true,
                perPage: 10,
